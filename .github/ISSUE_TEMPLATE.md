<!--
Thanks for taking the time to draft up an issue for Axon Framework's Spring Cloud Extension Sample!
Prior to starting off, please read the following:

## Usage Questions

If you are having difficulty using Axon Framework' Spring Cloud Extension Sample,
 please consider to check Axon's Reference Guide first if it answers your question: https://docs.axoniq.io/reference-guide/extensions/spring-cloud
...
You can find all three of them [here](https://github.com/AxonFramework/extension-springcloud-sample/issues/new/choose). 
